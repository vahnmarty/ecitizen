...
<div class="relative px-4 pt-16 pb-20 bg-gray-50 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
    ...
    <div class="relative mx-auto max-w-7xl">
        <div class="text-left">
            <h2 class="text-xl font-bold tracking-tight text-gray-900 sm:text-4xl">News and Announcements</h2>
        </div>
        <div class="grid max-w-lg gap-5 mx-auto mt-12 lg:max-w-none lg:grid-cols-3">
            @foreach($announcements as $article)
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
                <div class="flex-shrink-0">
                    <img class="object-cover w-full h-48"
                        src="{{ url('storage', $article->thumbnail) }}">
                </div>
                <div class="flex flex-col justify-between flex-1 p-6 bg-white">
                    <div class="flex-1">
                        <p class="text-sm font-medium text-indigo-600">
                            <a href="#" class="hover:underline">{{ $article->type->description }}</a>
                        </p>
