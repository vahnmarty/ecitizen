<div class="block lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-gray-100 shadow-[0px_16px_20px_10px_rgba(0,0,0,1)]">
    <div class="flex justify-between">
        <div class="flex w-full gap-2 px-6 py-4 cursor-pointer hover:bg-red-200">
            ...
            <a href="tel:911" class="font-bold">CALL 911</a>
        </div>
        <div class="flex justify-end w-full gap-2 px-6 py-4 cursor-pointer hover:bg-red-200">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-red-700">
                <path fill-rule="evenodd" d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z" clip-rule="evenodd" />
              </svg>
              
            <a href="tel:COVID" class="font-bold">COVID</a>
        </div>
    </div>

    <div class="absolute bottom-0 left-[50%] right-[50%] w-16 h-16 z-50 -ml-8 -mr-8 ">
        <div class="flex items-center justify-center">
            <div class="flex items-center justify-center w-16 h-16 rounded-full shadow-md cursor-pointer bg-blue-50 hover:bg-blue-100">
